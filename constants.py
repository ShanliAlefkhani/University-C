...
RULES = [
    ...
    "Stmt -> Loc = Expr ; | FuncCall ; | if (Expr) Block S1 | while (Expr) Block | return S2 ; | break ; | continue ; ",
    "S1 -> else Block | #",
    "S2 -> Expr | #",
...
VARIABLES = ["Program", "P1", "P2", "VarDecl", "V1", "Type", "FuncDecl", "F1", "P3", "Block", "B1", "B2", "Stmt", "S1", "S2", "Expr", "BaseExpr", "Loc", "L1", "FuncCall", "C1", "Args", "A1", "Lit", "BinOp", "UnOp"]
